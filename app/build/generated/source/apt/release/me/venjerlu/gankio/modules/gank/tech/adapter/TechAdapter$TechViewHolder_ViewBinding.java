...
public class TechAdapter$TechViewHolder_ViewBinding<T extends TechAdapter.TechViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public TechAdapter$TechViewHolder_ViewBinding(T target, View source) {
    this.target = target;
